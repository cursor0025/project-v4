  ...
  return (
    <div className="min-h-screen bg-[#0c0c0c] font-sans text-slate-900">
      ...
      <section className="relative w-full overflow-hidden bg-[#0c0c0c] pb-4 md:pb-6">
          ...
          {slides.map((s, i) => (
            ...
            >
              ...
              <div className="absolute top-[15%] md:top-[20%] left-0 right-0 mx-auto text-center space-y-3 md:space-y-6 max-w-4xl px-4">
                ...
                <p className="text-lg md:text-2xl lg:text-4xl font-bold tracking-tight opacity-90 text-white">
                  {s.subtitle}
                </p>
              </div>
        ...
        <div className="max-w-[1440px] mx-auto px-3 md:px-4 -mt-32 md:-mt-64 lg:-mt-[320px] relative z-30 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
          {AMAZON_OVERLAY_CARDS.map((card, i) => (
            <div
              key={i}
              className={`bg-white/40 backdrop-blur-md p-4 md:p-8 rounded-2xl md:rounded-[40px] shadow-2xl flex flex-col h-auto md:h-[520px] border-t-4 ${
                card.color === 'blue'
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-6 flex-1">
                {card.items.map((it, idx) => (
                  ...
                  >
                    ...
                    <p className="text-[8px] md:text-[10px] font-black text-slate-500 uppercase tracking-widest text-center truncate w-full">
                      {it.n}
                    </p>
                  </div>
                ))}
              ...
              <Link
                href="#"
                className={`mt-4 md:mt-auto w-full py-2 md:py-4 rounded-xl md:rounded-2xl text-center font-black uppercase tracking-[0.1em] text-[8px] md:text-[10px] transition-all flex items-center justify-center gap-2 ${
                  card.color === 'blue'
                    ? 'bg-blue-100 text-blue-700 hover:bg-blue-600 hover:text-white'
                    : 'bg-orange-100 text-[#ff7011] hover:bg-[#ff7011] hover:text-white'
                }`}
              >
                {card.link}{' '}
      ...
      <footer className="bg-[#131a22] text-slate-400 py-12 md:py-24 text-center px-4">
        <img
          src="/images/bzm-logo.png"
          className="h-8 md:h-10 mx-auto brightness-0 invert opacity-20 mb-6 md:mb-10"
          alt="Logo"
        />
        <p className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.5em]">
          © 2025 BZMARKET ALGERIA
        </p>
      </footer>
    </div>
  );
